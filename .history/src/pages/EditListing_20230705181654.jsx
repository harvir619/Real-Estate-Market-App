...
function EditListing() {
    ...
    const { type, name, bedrooms, bathrooms, parking, furnished,
        address, offer, regularPrice, discountedPrice, images, lat, long }
    = formData
    ...
    //This Fetches listing to Edit
    useEffect(() => {
        
        const fetchListing = async ()=>{
            try {
                setLoading(true)
                const ref = doc(db, 'listings', params.listingId)
