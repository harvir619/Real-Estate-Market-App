        ...
        <img src={arrowRight} alt="arrow" />
          ...
          <ul className="listingList">
            {listings.map((listing) => (
              <li key={listing.id} className="singleListing">
                <Link to={`/category/${listing.data.type}/${listing.id}`} className="singleListingLink">
                  <img src={listing.data.imageUrls[0]} alt={listing.data.name} />
                </Link>
              </li>
           ))}
          </ul>
